...
return (
    ...
    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-2 md:gap-0 mt-8 md:mt-20 px-2 md:px-0">
        <div className="flex flex-col items-center justify-center mx-2 md:ml-5 my-2 md:my-0">
            <div className="bg-gray-100 rounded-full flex items-center justify-center w-[90px] h-[90px] md:w-[170px] md:h-[170px]">
                ...
                <Image
                    ...
                    width={90}
                    height={90}
                    className="rounded-full object-cover bg-gray-100 w-[70px] h-[70px] md:w-[120px] md:h-[120px]"
                />
                </Link>
            </div>
    ...
    <div className="flex flex-col md:flex-row gap-2 md:gap-7 mt-6 md:mt-12 items-stretch justify-center">
        <div className="bg-blue-50 rounded-2xl w-full md:w-[425px] h-[120px] md:h-[175px] flex flex-col justify-between p-2 md:p-4 mb-2 md:mb-0">
        ...
        <div className="bg-blue-50 rounded-2xl w-full md:w-[425px] h-[120px] md:h-[175px] flex flex-col justify-between p-2 md:p-4 mb-2 md:mb-0">
            <div className="flex items-start">
                <Image
                    ...
                    className="ml-2 mr-2 md:mr-4 rounded-md w-8 h-8 md:w-16 md:h-16"
                />
                <span className="text-blue-500 text-base md:text-[1.75rem] ml-2 md:ml-4 mt-2 md:mt-4">ONE STOP SHOP</span>
            </div>
        ...
        <div className="bg-blue-50 rounded-2xl w-full md:w-[425px] h-[120px] md:h-[175px] flex flex-col justify-between p-2 md:p-4 mb-2 md:mb-0">
            <div className="flex items-start">
                <Image
                    ...
                    className="ml-2 mr-2 md:mr-4 rounded-md w-8 h-8 md:w-16 md:h-16"
                />
                <span className="text-blue-500 text-base md:text-[1.75rem] ml-2 md:ml-4 mt-2 md:mt-4">NEXT DAY DELIVERY</span>
            </div>
            <div className="ml-2 md:ml-4 mt-2 md:mb-4 text-black text-xs md:text-base">
...
<div className="grid grid-cols-4 lg:grid-cols-4 md:grid-cols-2 sm:grid-cols-1 mt-4 gap-4 lg:gap-0">
    <div className="flex flex-col items-start justify-start ml-10 lg:ml-10 md:ml-6 sm:ml-4">
        ...
        <span className="mb-2 hover:cursor-pointer hover:text-black/80 print:hover:cursor-default print:hover:text-current">About</span>
        <span className="mb-2 hover:cursor-pointer hover:text-black/80 print:hover:cursor-default print:hover:text-current">Contact Us</span>
        <span className="mb-2 hover:cursor-pointer hover:text-black/80 print:hover:cursor-default print:hover:text-current">Careers</span>
        <span className="mb-2 hover:cursor-pointer hover:text-black/80 print:hover:cursor-default print:hover:text-current">Sales Tax and Exemption</span>
        <span className="mb-2 hover:cursor-pointer hover:text-black/80 print:hover:cursor-default print:hover:text-current">ACH / e-Check Registration</span>
        <span className="mb-2 hover:cursor-pointer hover:text-black/80 print:hover:cursor-default print:hover:text-current">Terms & Conditions</span>
        <span className="mb-2 hover:cursor-pointer hover:text-black/80 print:hover:cursor-default print:hover:text-current">Privacy Notice</span>
        <span className="mb-2 hover:cursor-pointer hover:text-black/80 print:hover:cursor-default print:hover:text-current">Accessibility Statement</span>
        <span className="mb-2 hover:cursor-pointer hover:text-black/80 print:hover:cursor-default print:hover:text-current">Help</span>
        <span className="mb-2 hover:cursor-pointer hover:text-black/80 print:hover:cursor-default print:hover:text-current">FAQ</span>
    </div>
    ...
    <div className="flex flex-col items-start justify-start ml-10 lg:ml-10 md:ml-6 sm:ml-4">
        ...
        <span className="mb-2 hover:cursor-pointer hover:text-black/80 print:hover:cursor-default print:hover:text-current">Shop by Brand</span>
        <span className="mb-2 hover:cursor-pointer hover:text-black/80 print:hover:cursor-default print:hover:text-current">Clearance</span>
        <span className="mb-2 hover:cursor-pointer hover:text-black/80 print:hover:cursor-default print:hover:text-current">Daily Discounts</span>
        <span className="mb-2 hover:cursor-pointer hover:text-black/80 print:hover:cursor-default print:hover:text-current">Catalogs</span>
        <span className="mb-2 hover:cursor-pointer hover:text-black/80 print:hover:cursor-default print:hover:text-current">Vendor Literature</span>
    </div>
    ...
    <div className="flex flex-col items-start justify-start ml-10 lg:ml-10 md:ml-6 sm:ml-4">
        ...
        <span className="mb-2 hover:cursor-pointer hover:text-black/80 print:hover:cursor-default print:hover:text-current">SAM.gov - CAGE Code: 1UXJ6</span>
        <span className="mb-2 hover:cursor-pointer hover:text-black/80 print:hover:cursor-default print:hover:text-current">A & D Portal</span>
        <span className="mb-2 hover:cursor-pointer hover:text-black/80 print:hover:cursor-default print:hover:text-current">ORSY - Inventory Management Solution</span>
        <span className="mb-2 hover:cursor-pointer hover:text-black/80 print:hover:cursor-default print:hover:text-current">Machinery</span>
    </div>
...
<div className="grid grid-rows-1 mt-4">
    <div className="flex lg:flex-row md:flex-col sm:flex-col items-start justify-start">
        ...
        <div className="flex flex-row gap-4 mt-120 md:mt-0 lg:pt-10 md:pt-6 sm:pt-4 pr-10 lg:pr-10 md:pr-6 sm:pr-4 justify-end lg:justify-end md:justify-center sm:justify-center w-full">
            ...
            <FaXTwitter className="w-[20px] h-[20px] hover:cursor-pointer hover:text-red-800 print:hover:cursor-default print:hover:text-current" />
            <FaPinterest className="w-[20px] h-[20px] hover:cursor-pointer hover:text-red-800 print:hover:cursor-default print:hover:text-current" />
            <FaYoutube className="w-[20px] h-[20px] hover:cursor-pointer hover:text-red-800 print:hover:cursor-default print:hover:text-current" />
            <FaTiktok className="w-[20px] h-[20px] hover:cursor-pointer hover:text-red-800 print:hover:cursor-default print:hover:text-current" />
            <RiFilePaperFill className="w-[20px] h-[20px] hover:cursor-pointer hover:text-red-800 print:hover:cursor-default print:hover:text-current" />
        </div>
    </div>
</div>
...
<div className="mt-8 w-full flex lg:flex-row md:flex-col sm:flex-col items-start flex-wrap md:flex-nowrap justify-start px-10 lg:px-10 md:px-6 sm:px-4 text-neutral-400 text-xs gap-4 lg:gap-0">
    ...
    <div className="flex lg:justify-end md:justify-start sm:justify-start lg:flex-row md:flex-col sm:flex-col gap-4 lg:gap-4 md:gap-2 sm:gap-2 w-full lg:w-full md:w-auto sm:w-auto">
        <span className="text-neutral-400 hover:underline hover:cursor-pointer print:hover:no-underline print:hover:cursor-default">
            Terms & Conditions
        </span>
        <span className="text-neutral-400 hover:underline hover:cursor-pointer print:hover:no-underline print:hover:cursor-default">
            Privacy Notice
